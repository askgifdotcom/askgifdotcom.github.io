...
define([appLocation.userPostLogin], function (app) {
    ...
    app.controller('userAfterLoginAdminApproveGif', function ($scope, $http, $rootScope, $routeParams, $window, $location) {
        ...
        $scope.approveGif = function () {
            ...
            $http({
                url: '/api/AdminApproveImageAsset',
                method: "POST",
                data: JSON.stringify($scope.GifData),
                headers: headers
            }).success(function (data, status, headers, config) {
